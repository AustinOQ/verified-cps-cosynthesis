...
Used as an external Python shield by composite_model.py. The policy proposes an
action, then SpecShield evaluates the SysML #NeuralRequirement AST directly and
returns either the proposed action or a compliant override.
"""
...
# ---------------------------------------------------------------------------
# SpecShield — external runtime shield callable
# ---------------------------------------------------------------------------
...
class SpecShield:
    ...
    def __call__(self, proposed_action: int, obs_dict: dict) -> int:
        """Evaluate shield decision via AST and override if needed."""
